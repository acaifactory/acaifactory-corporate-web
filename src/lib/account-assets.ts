export const accountAssets = {
  ...
  formSpec: {
    ...
    eyebrowFontSize: "clamp(14px, 2.6vw, 31pt)",
    titleFontSize: "clamp(34px, 7vw, 87pt)",
    descriptionFontSize: "clamp(16px, 3.6vw, 36pt)",
    labelFontSize: "clamp(14px, 2.8vw, 28pt)",
    fieldFontSize: "clamp(16px, 3.6vw, 36pt)",
    fieldPaddingY: "clamp(0.85rem, 2.4vw, 2.375rem)",
    fieldPaddingX: "clamp(1rem, 2.6vw, 2.575rem)",
    submitFontSize: "clamp(18px, 4.1vw, 41pt)",
    closeFontSize: "clamp(22px, 3.9vw, 39pt)",
